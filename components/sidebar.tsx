...
const sidebarItems = [
  ...
  { href: "/report", icon: MapPin, label: "Laporan" },
  { href: "/collect", icon: Trash, label: "Pengangkutan" },
  { href: "/rewards", icon: Coins, label: "Poin" },
  { href: "/leaderboard", icon: Medal, label: "Kontribusi" },
]
